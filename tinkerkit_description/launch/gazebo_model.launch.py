...
def generate_launch_description():
    ...
    modelFileRelativePath = 'model/tinkerkit.xacro'
    ...
    gazebo_rosPackageLaunch=PythonLaunchDescriptionSource(os.path.join(get_package_share_directory('tinkerkit_description'),
    ...
    spawnModelNode = Node(package='tinkerkit_description', executable='spawn_entity.py',
